        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-xl-8 mb-3 mb-xl-0">
                    <div class="card" v-for="item in store.getCartItems" :key="item.id" >
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div class="d-flex col-8">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div>
                                        <span>{{ item.price }} <vue-feather type="x" size="12"/> {{ item.quantity }} = {{  item.price * item.quantity }} ৳</span>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column align-items-end">
                                <vue-feather type="x" size="15" class="cursor-pointer"/>
                                <QuantityButton class="mt-1"/>
                                <button class="btn btn-sm btn-primary mt-2">Move to wach list</button>
                            </div>
                        </div>
                    </div>
...
<!--
                            ...
                            <dd class="col-6 text-end"><s>$5.00</s> <span class="badge bg-success">Free</span></dd>
                    ...
                    <div class="d-grid">
                        <a :href="$page.props.auth.MAIN_URL+'/checkout'" class="btn btn-primary btn-next">Place Order</a>
                    </div>
                </div>
            </div>
