...
const addSpec = () => document.getElementById('addDisc').$vb.modal.show();
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="">
                                ...
                                <p class="border-bottom p-1 bg-light cursor-pointer" @click="addDisc"> {{ formData.description != null || formData.description != '' ? formData.description : 'e.g what you want to write about your product.' }}</p>
                            </div>
                        </div>
                    </div>
